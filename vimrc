...
let maplocalleader = "-" " Set local leader to hyphen
...
" equal window sizes
nnoremap <leader>= <c-w>=
" open previous buffer to in new buffer on right
nnoremap <leader>p :rightbelow vsplit bufname("#")<cr>
" highlight trailing whitespace
nnoremap <leader>tw :match Error /\v\s+$/<cr>
" delete trailing whitespace
nnoremap <leader>dw ma:%s/\v\s+$//<cr>`a
" clear previous match pattern
nnoremap <leader>mn :match none<cr>
" Mapping for toggling line numbers
nnoremap <leader>n :setlocal number!<cr>

" Remap for Gundo Plugin
...
" Color everything after column 80 differently
"let &colorcolumn="80,".join(range(120,999),",")
"highlight ColorColumn ctermbg=235 guibg=DarkGrey

" vimrc edit and sourcing shortcuts
nnoremap <leader>ev :vsplit $MYVIMRC<cr>
nnoremap <leader>sv :source $MYVIMRC<cr>

" Remap jk for escaping from insert and visual mode.
" Disable ESC and CTRL-C for now to relearn
"inoremap jk <esc>
...
" in next set of braces
onoremap in{ :<c-u>normal! f{vi{<cr>
" in last set of braces
onoremap il{ :<c-u>normal! F}vi{<cr>
" around next set of braces
onoremap an{ :<c-u>normal! f{v%<cr>
" around last set of braces
onoremap al{ :<c-u>normal! F{v%<cr>
